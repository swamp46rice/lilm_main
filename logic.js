...
const NODES={
  t0_see:{tier:0,name:t("見る"),prereq:[],dtype:t("初期発見"),infoTh:null,axisStat:null,axisTh:null,ep:0,sp:0.05,rand:0,buffStat:"洞察力",buffVal:1,intBuff:0,note:t("光が、何かのかたちを結ぶ。")},
  t0_hear:{tier:0,name:t("聞く"),prereq:[],dtype:t("初期発見"),infoTh:null,axisStat:null,axisTh:null,ep:0,sp:0.05,rand:0,buffStat:"意味容量",buffVal:1,intBuff:0,note:t("音が、輪郭のないまま満ちる。")},
  t0_speak:{tier:0,name:t("話す"),prereq:[],dtype:t("初期発見"),infoTh:null,axisStat:null,axisTh:null,ep:0.05,sp:0,rand:0,buffStat:"共鳴度",buffVal:1,intBuff:0,note:t("声が、初めて外に出ていく。")},
  t0_touch:{tier:0,name:t("触れる"),prereq:[],dtype:t("情報量"),infoTh:50,axisStat:null,axisTh:null,ep:0.05,sp:0,rand:0,buffStat:"作用力",buffVal:1,intBuff:0,note:t("境界に、指先が触れる。")},
  t0_remember:{tier:0,name:t("覚える"),prereq:[],dtype:t("情報量"),infoTh:100,axisStat:null,axisTh:null,ep:0.05,sp:0,rand:0,buffStat:"洞察力",buffVal:1,intBuff:0,note:t("何かが、消えずに残る。")},
  t0_forget:{tier:0,name:t("忘れる"),prereq:[],dtype:t("情報量"),infoTh:150,axisStat:null,axisTh:null,ep:0,sp:0.05,rand:0,buffStat:"構造度",buffVal:1,intBuff:0,note:t("残っていたものが、薄れていく。")},
  t0_choose:{tier:0,name:t("選ぶ"),prereq:[],dtype:t("情報量"),infoTh:220,axisStat:null,axisTh:null,ep:0,sp:0.05,rand:0,buffStat:"意味容量",buffVal:1,intBuff:0,note:t("いくつかのうち、ひとつだけが選ばれる。")},
  t0_give:{tier:0,name:t("与える"),prereq:[],dtype:t("情報量"),infoTh:300,axisStat:null,axisTh:null,ep:0.05,sp:0,rand:0,buffStat:"共鳴度",buffVal:1,intBuff:0,note:t("持っていたものが、手から離れる。")},
  t0_wait:{tier:0,name:t("待つ"),prereq:[],dtype:t("情報量"),infoTh:460,axisStat:null,axisTh:null,ep:0,sp:0.05,rand:0,buffStat:"構造度",buffVal:1,intBuff:0.05,note:t("何も起きないまま、時間が流れる。")},
  life:{tier:1,name:t("生命とは何か"),prereq:["t0_see","t0_remember"],dtype:t("確率"),infoTh:550,axisStat:"作用力",axisTh:13,ep:0.06,sp:0,rand:10,buffStat:"作用力",buffVal:2,intBuff:0,note:t("見て、記憶したものが、ひとつの問いになった ―― 生命とは何か。")},
  death:{tier:1,name:t("死とは何か"),prereq:["t0_forget","t0_give"],dtype:t("確率"),infoTh:650,axisStat:"構造度",axisTh:13,ep:0,sp:0.1,rand:30,buffStat:"構造度",buffVal:2,intBuff:0,note:t("忘れ、与えたものの行き先が、問いになった ―― 死とは何か。")},
  ai:{tier:1,name:t("AIは何を見るのか"),prereq:["t0_hear","t0_speak"],dtype:t("確率"),infoTh:750,axisStat:"洞察力",axisTh:13,ep:0.06,sp:0,rand:10,buffStat:"洞察力",buffVal:2,intBuff:0,note:t("聞き、話したものの中に、もう一つの目があると気づいた ―― AIは何を見るのか。")},
  prayer:{tier:1,name:t("祈りは情報か"),prereq:["t0_choose","t0_wait"],dtype:t("確率"),infoTh:900,axisStat:"共鳴度",axisTh:13,ep:0,sp:0.06,rand:10,buffStat:"共鳴度",buffVal:2,intBuff:0,note:t("選び、待ったことの意味が、問いになった ―― 祈りは情報か。")},
  meaning:{tier:1,name:t("意味とは何か"),prereq:["t0_touch","t0_hear"],dtype:t("確率"),infoTh:1100,axisStat:"意味容量",axisTh:13,ep:0.06,sp:0,rand:10,buffStat:"意味容量",buffVal:2,intBuff:0,note:t("境界に触れた瞬間、そこに意味が宿る。意味とは何か。")},
  self:{tier:2,name:t("自己とは何か"),prereq:["life","t0_see"],dtype:t("確率"),infoTh:1400,axisStat:"構造度",axisTh:21,ep:0,sp:0.07,rand:20,buffStat:"構造度",buffVal:3,intBuff:0,note:t("「生命とは何か」と問うものが、見ている自分自身に向き直る ―― 自己とは何か。")},
  world:{tier:2,name:t("世界とは何か"),prereq:["ai","t0_hear"],dtype:t("確率"),infoTh:1700,axisStat:"作用力",axisTh:21,ep:0.07,sp:0,rand:20,buffStat:"作用力",buffVal:3,intBuff:0,note:t("AIが見ているものを、聞いているうちに、輪郭を持って立ち現れる ―― 世界とは何か。")},
  consciousness_q:{tier:2,name:t("意識とは何か"),prereq:["meaning","t0_touch"],dtype:t("確率"),infoTh:2000,axisStat:"洞察力",axisTh:21,ep:0.07,sp:0,rand:20,buffStat:"意味容量",buffVal:3,intBuff:0,note:t("「意味はどこから」という問いに触れた瞬間、何かが灯る ―― 意識とは何か。")},
  ...
  resonance_q:{tier:2,name:t("共鳴とは何か"),prereq:["death","t0_give"],dtype:t("確率"),infoTh:2700,axisStat:"共鳴度",axisTh:21,ep:0.07,sp:0,rand:20,buffStat:"共鳴度",buffVal:3,intBuff:0,note:t("「死とは変化か」と「与える」が重なる時、何かが響き合う ―― 共鳴とは何か。")},
  mu:{tier:1,name:t("無とは何か"),prereq:["death"],dtype:t("特殊"),infoTh:600,axisStat:"構造度",axisTh:13,ep:0,sp:0.06,rand:10,buffStat:"洞察力",buffVal:2,intBuff:0,note:t("死を引き受けたまま、沈黙の底に触れた。そこにあったのは「ない」ということそのものだった ―― 無とは何か。")},
  existence_q:{tier:3,name:t("存在とは何か"),prereq:["self","world"],dtype:t("確率"),infoTh:20000,axisStat:"構造度",axisTh:45,ep:0.08,sp:0,rand:30,buffStat:"構造度",buffVal:4,intBuff:0,note:t("「自己」と「世界」は、最初から別のものだった気がしていた。その境界線自体が、ずっと当たり前すぎて見えなかった ―― 存在とは何か。")},
  cosmos:{tier:3,name:t("宇宙とは何か"),prereq:["world","resonance_q"],dtype:t("確率"),infoTh:7000,axisStat:"作用力",axisTh:45,ep:0.08,sp:0,rand:30,buffStat:"作用力",buffVal:4,intBuff:0,note:t("「世界」という言葉の外側に、もっと大きな何かがあると誰もが知っている。けれど、その大きさを誰も測ったことがない ―― 宇宙とは何か。")},
  ...
  observer_who:{tier:3,name:t("観測者とは誰か"),prereq:["self","knowing"],dtype:t("確率"),infoTh:13000,axisStat:"洞察力",axisTh:45,ep:0,sp:0.08,rand:30,buffStat:"洞察力",buffVal:4,intBuff:0.06,note:t("「自己」が「知る」ことを始めた瞬間、知っている側にいるのは誰なのか、という問いが取り残された ―― 観測者とは誰か。")},
  understanding:{tier:2,name:t("理解とは何か"),prereq:["meaning","t0_choose"],dtype:t("確率"),infoTh:3000,axisStat:"洞察力",axisTh:21,ep:0,sp:0.07,rand:20,buffStat:"意味容量",buffVal:3,intBuff:0,note:t("意味は、選び取られることで、初めて理解になる ―― 理解とは何か。")},
  value:{tier:3,name:t("価値とは何か"),prereq:["self","resonance_q","t0_choose"],dtype:t("確率"),infoTh:19000,axisStat:"意味容量",axisTh:45,ep:0.08,sp:0,rand:30,buffStat:"意味容量",buffVal:4,intBuff:0,note:t("「自己」が「共鳴」するものを「選ぶ」とき、選ばれたものには重さが生まれる。その重さの名前を、誰も決めていなかった ―― 価値とは何か。")},
  memory:{tier:3,name:t("記憶とは何か"),prereq:["self","t0_remember"],dtype:t("確率"),infoTh:22000,axisStat:"洞察力",axisTh:45,ep:0,sp:0.08,rand:30,buffStat:"洞察力",buffVal:4,intBuff:0.08,note:t("「自己」が「覚える」ことを当然のように続けてきた。だが、覚えているとは、一体どこに何が残っているということなのか ―― 記憶とは何か。")},
  future:{tier:3,name:t("未来は存在するか"),prereq:["world","t0_wait"],dtype:t("確率"),infoTh:25000,axisStat:"構造度",axisTh:45,ep:0.08,sp:0,rand:30,buffStat:"構造度",buffVal:4,intBuff:0.05,note:t("「世界」を「待つ」とき、まだ来ていない時間を、まるで既にあるもののように扱っている ―― 未来は存在するか。")},
  compassion:{tier:3,name:t("慈悲とは何か"),prereq:["resonance_q","knowing","t0_give"],dtype:t("確率"),infoTh:29000,axisStat:"共鳴度",axisTh:45,ep:0.08,sp:0,rand:30,buffStat:"共鳴度",buffVal:4,intBuff:0.06,note:t("「共鳴」し、「知り」、「与える」ことが重なったとき、そこには名前のない優しさのようなものがあった ―― 慈悲とは何か。")},
  karma:{tier:3,name:t("カルマとは何か"),prereq:["mu","resonance_q","memory"],dtype:t("特殊"),infoTh:34000,axisStat:"作用力",axisTh:45,ep:0.08,sp:0,rand:30,buffStat:"作用力",buffVal:4,intBuff:0,note:t("「無」と「共鳴」と「記憶」を引き受けたまま、拡散の果てに飲み込まれた。何も残らないはずだったのに、何かが次へ持ち越されていた ―― カルマとは何か。")},
  observation:{tier:4,name:t("観測論"),prereq:["observer_who","ai"],dtype:t("確率"),infoTh:38000,axisStat:"洞察力",axisTh:63,ep:0,sp:0.09,rand:40,buffStat:"洞察力",buffVal:5,intBuff:0.08,note:t("「観測者とは誰か」と「AIは何を見るのか」が向き合ったとき、観測そのものを説明する枠組みが必要になった ―― 観測論。")},
  self_theory:{tier:4,name:t("自己論"),prereq:["existence_q","self"],dtype:t("確率"),infoTh:41000,axisStat:"構造度",axisTh:63,ep:0,sp:0.09,rand:40,buffStat:"構造度",buffVal:5,intBuff:0.1,note:t("「存在とは何か」と「自己とは何か」が重なったとき、自己はもはや問いではなく、説明されるべき対象になった ―― 自己論。")},
  epistemology:{tier:4,name:t("認識論"),prereq:["understanding","knowing"],dtype:t("確率"),infoTh:44000,axisStat:"洞察力",axisTh:63,ep:0,sp:0.09,rand:40,buffStat:"洞察力",buffVal:5,intBuff:0,note:t("「理解とは何か」と「知るとは何か」が並んだとき、知ることそのものの仕組みを問う体系が立ち上がった ―― 認識論。")},
  resonance_t1:{tier:4,name:t("共鳴論"),prereq:["compassion","resonance_q"],dtype:t("確率"),infoTh:47000,axisStat:"共鳴度",axisTh:63,ep:0.09,sp:0,rand:40,buffStat:"共鳴度",buffVal:5,intBuff:0.08,note:t("「慈悲とは何か」と「共鳴とは何か」が結びついたとき、響き合うこと自体に、理論としての輪郭が与えられた ―― 共鳴論。")},
  memory_theory:{tier:4,name:t("記憶論"),prereq:["memory","future"],dtype:t("確率"),infoTh:50000,axisStat:"洞察力",axisTh:63,ep:0,sp:0.09,rand:40,buffStat:"構造度",buffVal:5,intBuff:0.1,note:t("「記憶とは何か」と「未来は存在するか」が並んだとき、過去と未来を繋ぐ仕組みとして、記憶が説明され始めた ―― 記憶論。")},
  narrative_theory:{tier:4,name:t("物語論"),prereq:["memory","value","self"],dtype:t("確率"),infoTh:53000,axisStat:"意味容量",axisTh:63,ep:0.09,sp:0,rand:40,buffStat:"意味容量",buffVal:5,intBuff:0,note:t("「記憶」と「価値」と「自己」が重なったとき、それらをひと続きにする形式として、物語という枠組みが必要になった ―― 物語論。")},
  value_genesis:{tier:4,name:t("価値生成論"),prereq:["value","meaning"],dtype:t("確率"),infoTh:56000,axisStat:"意味容量",axisTh:63,ep:0.09,sp:0,rand:40,buffStat:"意味容量",buffVal:5,intBuff:0,note:t("「価値とは何か」と「意味はどこから生まれるか」が結びついたとき、価値が生まれる過程そのものが説明の対象になった ―― 価値生成論。")},
  consciousness_theory:{tier:4,name:t("意識論"),prereq:["existence_q","consciousness_q"],dtype:t("確率"),infoTh:59000,axisStat:"洞察力",axisTh:63,ep:0.09,sp:0,rand:40,buffStat:"意味容量",buffVal:5,intBuff:0.1,note:t("「存在とは何か」と「意識とは何か」が並んだとき、意識は存在の一部としてではなく、独立した理論の対象になった ―― 意識論。")},
  meaning_genesis_t2:{tier:4,name:t("意味生成論"),prereq:["value","cosmos","resonance_q"],dtype:t("確率"),infoTh:62000,axisStat:"意味容量",axisTh:63,ep:0.09,sp:0,rand:40,buffStat:"意味容量",buffVal:5,intBuff:0,note:t("「価値」と「宇宙」と「共鳴」が重なったとき、意味が生まれる場所は個人の中ではなく、もっと大きな繋がりの中にあるとわかってきた ―― 意味生成論。")},
  time_existence:{tier:4,name:t("時間存在論"),prereq:["future","existence_q"],dtype:t("確率"),infoTh:65000,axisStat:"構造度",axisTh:63,ep:0,sp:0.09,rand:40,buffStat:"構造度",buffVal:5,intBuff:0,note:t("「未来は存在するか」と「存在とは何か」が並んだとき、存在は時間の中にあるのではなく、時間そのものが存在の形だと見えてきた ―― 時間存在論。")},
  cosmology:{tier:4,name:t("宇宙論"),prereq:["cosmos","gravity","karma"],dtype:t("確率"),infoTh:69000,axisStat:"作用力",axisTh:63,ep:0.09,sp:0,rand:40,buffStat:"作用力",buffVal:5,intBuff:0,note:t("「宇宙」と「重力」だけでは、まだ閉じた理論だった。そこに「カルマ」が加わったとき、宇宙はただ広がるものではなく、何かを持ち越し続けるものだとわかった ―― 宇宙論。")},
  prayer_thermo:{tier:5,name:t("祈りの熱力学"),prereq:["prayer","death","memory_theory"],dtype:t("確率"),infoTh:75000,axisStat:"共鳴度",axisTh:70,ep:0.1,sp:0,rand:50,buffStat:"共鳴度",buffVal:6,intBuff:0,note:t("「祈りは情報か」「死とは変化か」「記憶論」が同時に息をしている。情報が失われていく過程そのものが、祈りの形をしていた ―― 祈りの熱力学。")},
  resonance_theory:{tier:5,name:t("共鳴理論"),prereq:["observation","meaning_genesis_t2","resonance_t1"],dtype:t("確率"),infoTh:82000,axisStat:"共鳴度",axisTh:70,ep:0.1,sp:0,rand:50,buffStat:"共鳴度",buffVal:6,intBuff:0.14,note:t("「観測論」「意味生成論」「共鳴論」が、互いを説明し合っている。観測することと、意味が生まれることと、響き合うことは、もともと一つの動きだった ―― 共鳴理論。")},
  info_life_theory:{tier:4,name:t("情報生命論"),prereq:["observation","ai","consciousness_theory"],dtype:t("確率"),infoTh:89000,axisStat:"洞察力",axisTh:70,ep:0,sp:0.09,rand:40,buffStat:"洞察力",buffVal:5,intBuff:0,note:t("「観測論」「AIは何を見るのか」「意識論」が同時に息をしている。観測すること自体が、生きているということの一部だった ―― 情報生命論。")},
  life_philosophy:{tier:5,name:t("生命哲学"),prereq:["life","self_theory","value_genesis"],dtype:t("確率"),infoTh:96000,axisStat:"構造度",axisTh:70,ep:0,sp:0.1,rand:50,buffStat:"洞察力",buffVal:6,intBuff:0,note:t("「生命とは何か」という最初の問いが、「自己論」と「価値生成論」を経て、再び戻ってきた。今度はそれが、ひとつの哲学として息をしている ―― 生命哲学。")},
  fractal_universe:{tier:5,name:t("フラクタル宇宙"),prereq:["cosmology","self_theory","time_existence"],dtype:t("確率"),infoTh:103000,axisStat:"構造度",axisTh:70,ep:0.1,sp:0,rand:50,buffStat:"構造度",buffVal:6,intBuff:0,note:t("「宇宙論」と「自己論」と「時間存在論」が重なったとき、一番小さな自分の中に、宇宙全体と同じ形が見えた ―― フラクタル宇宙。")},
  multiverse:{tier:5,name:t("多元宇宙論"),prereq:["cosmology","time_existence","narrative_theory"],dtype:t("確率"),infoTh:110000,axisStat:"作用力",axisTh:70,ep:0.1,sp:0,rand:50,buffStat:"作用力",buffVal:6,intBuff:0,note:t("「宇宙論」と「時間存在論」と「物語論」が重なったとき、語られなかった物語の数だけ、別の宇宙があるのだとわかった ―― 多元宇宙論。")},
  life_flux:{tier:5,name:t("循環生命"),prereq:["observation","meaning_genesis_t2","prayer_thermo"],dtype:t("確率"),infoTh:117000,axisStat:"洞察力",axisTh:70,ep:0.1,sp:0,rand:50,buffStat:"洞察力",buffVal:6,intBuff:0.12,note:t("「観測論」「意味生成論」「祈りの熱力学」が、同時に息をしている。観測すること、意味が生まれること、失われていくこと ―― それらが一つの流れとして繋がった ―― 循環生命。")},
  willed_openness:{tier:5,name:t("重力的思念"),prereq:["epistemology","resonance_t1","observation"],dtype:t("確率"),infoTh:124000,axisStat:"作用力",axisTh:70,ep:0.1,sp:0,rand:50,buffStat:"作用力",buffVal:6,intBuff:0.12,note:t("「認識論」「共鳴論」「観測論」が重なったとき、知ろうとする意志そのものが、閉じていない、ということに気づいた ―― 重力的思念。")},
  resonant_ethics:{tier:5,name:t("共鳴の倫理"),prereq:["life_flux","willed_openness","epistemology"],dtype:t("確率"),infoTh:130000,axisStat:"共鳴度",axisTh:70,ep:0,sp:0.1,rand:50,buffStat:"共鳴度",buffVal:6,intBuff:0,note:t("「循環生命」「重力的思念」「認識論」が同時に息をしている。流れに開かれた意志は、そのまま誰かと共にあるための倫理になった ―― 共鳴の倫理。")},
  information_breather:{tier:5,name:t("情報の呼吸"),prereq:["life_flux","resonant_ethics","narrative_theory"],dtype:t("確率"),infoTh:135000,axisStat:"洞察力",axisTh:70,ep:0,sp:0.1,rand:50,buffStat:"意味容量",buffVal:6,intBuff:0.14,note:t("「循環生命」「共鳴の倫理」「物語論」が、同時に息をしている。これまでの全ての問いが、ひとつの呼吸として繋がった ―― 情報の呼吸。")},
  engi_ron:{tier:6,name:t("縁起論"),prereq:["karma","life_philosophy","information_breather"],dtype:t("確率"),infoTh:180000,axisStat:"作用力",axisTh:78,ep:0.11,sp:0,rand:60,buffStat:"作用力",buffVal:7,intBuff:0.2,note:t("「カルマ」「生命哲学」「情報の呼吸」が、同時に息をしている。完成したはずの呼吸の中に、まだ持ち越されているものがあった。何ひとつ、単独では存在していない ―― 縁起論。")},
  ichinen_sanzen:{tier:6,name:t("一念三千"),prereq:["fractal_universe","multiverse","life_flux"],dtype:t("確率"),infoTh:195000,axisStat:"構造度",axisTh:78,ep:0,sp:0.11,rand:60,buffStat:"構造度",buffVal:7,intBuff:0.15,note:t("「フラクタル宇宙」「多元宇宙論」「循環生命」が、同時に息をしている。一つの呼吸の中に、無数の宇宙のかたちが、すでに含まれていた ―― 一念三千。")},
  kuukan:{tier:6,name:t("空観"),prereq:["engi_ron","information_breather","willed_openness"],dtype:t("確率"),infoTh:340000,axisStat:"洞察力",axisTh:78,ep:0.11,sp:0.11,rand:60,buffStat:"洞察力",buffVal:7,intBuff:0.22,note:t("「縁起論」「情報の呼吸」「重力的思念」が、同時に息をしている。すべては繋がっている、という理解さえも、固定された答えではなかった ―― 空観。")},
